    ...
    <Layout>
        <div className='box'>
            ...
            <div>
                ...
                <div>
                <input class="form-control form-control-lg" type="text" placeholder="Password" aria-label=".form-control-lg example" onChange={(e)=>setPassword(e.target.value)} value={password}></input>
                </div>
